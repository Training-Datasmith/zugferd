...
class Header_Trade_Settlement_Type
{
     ...
     */
    public function set_creditor_reference_id(?\horstoeko\zugferd\entities\basicwl\udt\Id_Type $creditor_reference_id = null): self
    {
     ...
     */
    public function set_payee_trade_party(?\horstoeko\zugferd\entities\basicwl\ram\Trade_Party_Type $payee_trade_party = null): self
    {
     ...
     */
    public function add_to_specified_trade_settlement_payment_means(\horstoeko\zugferd\entities\basicwl\ram\Trade_Settlement_Payment_Means_Type $specified_trade_settlement_payment_means): self
    {
     ...
     */
    public function add_to_applicable_trade_tax(\horstoeko\zugferd\entities\basicwl\ram\Trade_Tax_Type $applicable_trade_tax): self
    {
     ...
     */
    public function set_billing_specified_period(?\horstoeko\zugferd\entities\basicwl\ram\Specified_Period_Type $billing_specified_period = null): self
    {
     ...
     */
    public function add_to_specified_trade_allowance_charge(\horstoeko\zugferd\entities\basicwl\ram\Trade_Allowance_Charge_Type $specified_trade_allowance_charge): self
    {
     ...
     */
    public function set_specified_trade_payment_terms(?\horstoeko\zugferd\entities\basicwl\ram\Trade_Payment_Terms_Type $specified_trade_payment_terms = null): self
    {
     ...
     */
    public function set_specified_trade_settlement_header_monetary_summation(\horstoeko\zugferd\entities\basicwl\ram\Trade_Settlement_Header_Monetary_Summation_Type $specified_trade_settlement_header_monetary_summation): self
    {
     ...
     */
    public function add_to_invoice_referenced_document(\horstoeko\zugferd\entities\basicwl\ram\Referenced_Document_Type $invoice_referenced_document): self
    {
     ...
     */
    public function set_receivable_specified_trade_accounting_account(?\horstoeko\zugferd\entities\basicwl\ram\Trade_Accounting_Account_Type $receivable_specified_trade_accounting_account = null): self
    {
