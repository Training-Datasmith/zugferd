...
class Exchanged_Document_Type
{
     ...
     */
    public function set_issue_date_time(\horstoeko\zugferd\entities\en16931\udt\Date_Time_Type $issue_date_time): self
    {
     ...
     */
    public function add_to_included_note(\horstoeko\zugferd\entities\en16931\ram\Note_Type $included_note): self
    {
