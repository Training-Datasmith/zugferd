...
class Specified_Period_Type
{
     ...
     */
    public function set_start_date_time(?\horstoeko\zugferd\entities\en16931\udt\Date_Time_Type $start_date_time = null): self
    {
     ...
     */
    public function set_end_date_time(?\horstoeko\zugferd\entities\en16931\udt\Date_Time_Type $end_date_time = null): self
    {
