...
class Trade_Party_Type
{
     ...
     * Adds as iD
     */
    public function add_to_id(\horstoeko\zugferd\entities\en16931\udt\Id_Type $i_d): self
    {
        $this->i_d[] = $i_d;
        return $this;
    }
     ...
     * Adds as globalID
     */
    public function add_to_global_id(\horstoeko\zugferd\entities\en16931\udt\Id_Type $global_id): self
    {
     ...
     */
    public function set_specified_legal_organization(?\horstoeko\zugferd\entities\en16931\ram\Legal_Organization_Type $specified_legal_organization = null): self
    {
     ...
     */
    public function set_defined_trade_contact(?\horstoeko\zugferd\entities\en16931\ram\Trade_Contact_Type $defined_trade_contact = null): self
    {
     ...
     */
    public function set_postal_trade_address(?\horstoeko\zugferd\entities\en16931\ram\Trade_Address_Type $postal_trade_address = null): self
    {
     ...
     */
    public function set_uri_universal_communication(?\horstoeko\zugferd\entities\en16931\ram\Universal_Communication_Type $u_ri_universal_communication = null): self
    {
     ...
     */
    public function add_to_specified_tax_registration(\horstoeko\zugferd\entities\en16931\ram\Tax_Registration_Type $specified_tax_registration): self
    {
