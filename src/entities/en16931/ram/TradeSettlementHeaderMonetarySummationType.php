...
class TradeSettlementHeaderMonetarySummationType
{
     ...
     */
    public function setChargeTotalAmount(?\horstoeko\zugferd\entities\en16931\udt\AmountType $chargeTotalAmount = null): self
    {
     ...
     */
    public function setAllowanceTotalAmount(?\horstoeko\zugferd\entities\en16931\udt\AmountType $allowanceTotalAmount = null): self
    {
     ...
     */
    public function setTaxBasisTotalAmount(\horstoeko\zugferd\entities\en16931\udt\AmountType $taxBasisTotalAmount): self
    {
     ...
     */
    public function addToTaxTotalAmount(\horstoeko\zugferd\entities\en16931\udt\AmountType $taxTotalAmount): self
    {
     ...
     */
    public function setRoundingAmount(?\horstoeko\zugferd\entities\en16931\udt\AmountType $roundingAmount = null): self
    {
     ...
     */
    public function setGrandTotalAmount(\horstoeko\zugferd\entities\en16931\udt\AmountType $grandTotalAmount): self
    {
     ...
     */
    public function setTotalPrepaidAmount(?\horstoeko\zugferd\entities\en16931\udt\AmountType $totalPrepaidAmount = null): self
    {
     ...
     */
    public function setDuePayableAmount(\horstoeko\zugferd\entities\en16931\udt\AmountType $duePayableAmount): self
    {
