...
class Cross_Industry_Invoice_Type
{
     ...
     */
    public function set_exchanged_document_context(\horstoeko\zugferd\entities\basic\ram\Exchanged_Document_Context_Type $exchanged_document_context): self
    {
     ...
     */
    public function set_exchanged_document(\horstoeko\zugferd\entities\basic\ram\Exchanged_Document_Type $exchanged_document): self
    {
     ...
     */
    public function set_supply_chain_trade_transaction(\horstoeko\zugferd\entities\basic\ram\Supply_Chain_Trade_Transaction_Type $supply_chain_trade_transaction): self
    {
