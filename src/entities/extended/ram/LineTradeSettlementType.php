...
class Line_Trade_Settlement_Type
{
     ...
     */
    public function set_specified_trade_settlement_line_monetary_summation(\horstoeko\zugferd\entities\extended\ram\Trade_Settlement_Line_Monetary_Summation_Type $specified_trade_settlement_line_monetary_summation): self
    {
     ...
     */
    public function set_invoice_referenced_document(?\horstoeko\zugferd\entities\extended\ram\Referenced_Document_Type $invoice_referenced_document = null): self
    {
     ...
     */
    public function set_receivable_specified_trade_accounting_account(?\horstoeko\zugferd\entities\extended\ram\Trade_Accounting_Account_Type $receivable_specified_trade_accounting_account = null): self
    {
