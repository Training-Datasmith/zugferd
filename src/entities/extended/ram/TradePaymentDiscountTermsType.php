 ...
 */
class Trade_Payment_Discount_Terms_Type
{
    /**
     ...
     */
    private $actual_discount_amount;
    /**
     ...
     * @return \horstoeko\zugferd\entities\extended\udt\AmountType
     */
    public function get_actual_discount_amount()
    {
     ...
     */
    public function set_actual_discount_amount(?\horstoeko\zugferd\entities\extended\udt\Amount_Type $actual_discount_amount = null): self
    {
        $this->actual_discount_amount = $actual_discount_amount;
        return $this;
    }
}