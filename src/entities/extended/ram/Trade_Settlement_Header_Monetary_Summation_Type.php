...
class Trade_Settlement_Header_Monetary_Summation_Type
{
     ...
     */
    public function set_tax_basis_total_amount(\horstoeko\zugferd\entities\extended\udt\Amount_Type $tax_basis_total_amount): self
    {
     ...
     */
    public function add_to_tax_total_amount(\horstoeko\zugferd\entities\extended\udt\Amount_Type $tax_total_amount): self
    {
     ...
     */
    public function set_rounding_amount(?\horstoeko\zugferd\entities\extended\udt\Amount_Type $rounding_amount = null): self
    {
     ...
     */
    public function set_grand_total_amount(\horstoeko\zugferd\entities\extended\udt\Amount_Type $grand_total_amount): self
    {
     ...
     */
    public function set_total_prepaid_amount(?\horstoeko\zugferd\entities\extended\udt\Amount_Type $total_prepaid_amount = null): self
    {
     ...
     */
    public function set_due_payable_amount(\horstoeko\zugferd\entities\extended\udt\Amount_Type $due_payable_amount): self
    {
